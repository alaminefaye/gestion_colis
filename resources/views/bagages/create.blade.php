...
@section('title', 'Ajouter un Bagage')
...
<div class="row">
  <div class="col-12">
    ...
    <form action="{{ route('application.bagages.store') }}" method="POST">
      @csrf
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5>Nouveau Bagage</h5>
        ...
        <div class="card-body">
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <div class="form-check-inline">
                <input class="form-check-input" type="radio" name="possede_ticket" id="ticket_oui" value="1" {{ old('possede_ticket') == '1' ? 'checked' : '' }}>
                <label class="form-check-label btn btn-outline-primary" for="ticket_oui">
                  Oui
                </label>
              </div>
              <div class="form-check-inline">
                <input class="form-check-input" type="radio" name="possede_ticket" id="ticket_non" value="0" {{ old('possede_ticket') == '0' ? 'checked' : '' }}>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="numero" name="numero" 
                     value="{{ old('numero') }}" placeholder="Saisir le numéro du bagage" required>
            </div>

            <!-- N° Ticket -->
            <div class="col-md-6 mb-3" id="numero_ticket_field" style="display: none;">
              ...
              <input type="text" class="form-control" id="numero_ticket" name="numero_ticket" 
                     value="{{ old('numero_ticket') }}" placeholder="Numéro du ticket">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="nom_famille" name="nom_famille" 
                     value="{{ old('nom_famille') }}" placeholder="Nom de famille" required>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" class="form-control" id="valeur" name="valeur" 
                     value="{{ old('valeur') }}" placeholder="Valeur en FCFA">
            </div>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" class="form-control" id="montant" name="montant" 
                     value="{{ old('montant') }}" placeholder="Montant en FCFA">
            </div>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" step="0.01" class="form-control" id="poids" name="poids" 
                     value="{{ old('poids') }}" placeholder="Poids en kg">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="contenu" name="contenu" rows="4" 
                      placeholder="Description du contenu du bagage">{{ old('contenu') }}</textarea>
          </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Vérifier l'état initial (pour old() values)
    if (ticketOui.checked) {
        numeroTicketField.style.display = 'block';
        numeroTicketInput.required = true;
    }
